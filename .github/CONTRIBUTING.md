...
- The solution is `Codebelt.Extensions.Globalization.slnx`. Central package versions are maintained in `Directory.Packages.props`.
...
- `Codebelt.Extensions.Globalization.slnx` is the solution used for local development.
...
```powershell
dotnet restore "Codebelt.Extensions.Globalization.slnx"
dotnet build "Codebelt.Extensions.Globalization.slnx" --configuration Release --no-restore
```
...
```powershell
dotnet pack "Codebelt.Extensions.Globalization.slnx" --configuration Release --no-restore
```
...
By contributing to Extensions for Globalization API by Codebelt, you agree that your contributions will be licensed under the MIT license.
